...
$(document).ready(function(){
    $("#user_data").submit(function(event){
        ...
        if (!/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/.test($('#user_password').val())) {
            alert("Please enter an 8-character password with at least one letter and one number");
            $('#user_password').focus();
            return;
        }
    ...
    $("#forgot_password_form").submit(function(event){
        ...
        if (!/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/.test($('#new_password').val())) {
            alert("Please enter an 8-character password with at least one letter and one number");
            $('#new_password').focus();
            return;
        }
    ...
    $("#create_account_form").submit(function(event){
        ...
        if (!/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/.test($('#create_password').val())) {
            alert("Please enter an 8-character password with at least one letter and one number");
